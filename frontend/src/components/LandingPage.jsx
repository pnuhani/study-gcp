    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16">
            <div className="text-center mb-12">
                <h1 className="text-5xl font-bold text-[#3a5a78] mb-4">QwerVego</h1>
                    ...
                    <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="text-center p-4">
                                <div className="bg-[#3a5a78]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <span className="text-2xl text-[#3a5a78]">1</span>
                                </div>
                            ...
                            <div className="text-center p-4">
                                <div className="bg-[#3a5a78]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <span className="text-2xl text-[#3a5a78]">2</span>
                                </div>
                            ...
                            <div className="text-center p-4">
                                <div className="bg-[#3a5a78]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <span className="text-2xl text-[#3a5a78]">3</span>
                                </div>
                    ...
                    <div className="border-t pt-8">
                        ...
                        <ul className="grid md:grid-cols-2 gap-4">
                            <li className="flex items-start space-x-3">
                                <svg className="h-6 w-6 text-[#3a5a78] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
